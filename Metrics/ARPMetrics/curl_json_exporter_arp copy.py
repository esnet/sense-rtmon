...
receiver_ip_address = "http://" + str(config_data['hostIP'])
      ...
      if output != pastOut:
        ...
        for entry in response:
          try: 
            ...
            url = f"{receiver_ip_address}:9192/metrics/job/arpMetrics/instance/{instance_ip}/hostname/{str(hostname)}/mac_address/ {str(entry['mac'])}/ip_address/{str(entry['ip'])}"
        ...
        url2 = f"{receiver_ip_address}:9192/metrics/job/arpMetrics/instance/{instance_ip}/entryCount/value"
