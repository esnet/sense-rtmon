...
tcpdumpCMDs = []
tcpdumpCMDs.append("tcpdump -G 2 -W 1 -i" + data['hostA']['interfaceName'] + " -s 100 host " + data['hostA']['IP'] +" -nA -w tcpdumpA.pcap")
tcpdumpCMDs.append("tcpdump -G 2 -W 1 -i" + data['hostB']['interfaceName'] + " -s 100 host " + data['hostB']['IP'] +" -nA -w tcpdumpB.pcap")
