...
class SenseAPI:
    ...
    def s_getMetadataRegData(self):
        ...
        data["description"].append(
            """RTMon (Real-Time Monitoring) is an automated service within the SENSE project designed to dynamically monitor and visualize
