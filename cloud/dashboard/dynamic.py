...
cmd1 = f"curl {pushgateway_metrics} | tac | grep '.*ifName.*ifName=\"{str(data['hostA']['switchPort']['ifName'])}\".*'"
...
cmd2 = f"curl {pushgateway_metrics} | tac | grep '.*ifName.*ifName=\"{str(data['hostB']['switchPort']['ifName'])}\".*'"
