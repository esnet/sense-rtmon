#!/bin/bash 
        ...
        # check_arp_on
        if curl http://dev2.virnao.com:9091/metrics | grep '.*arp_state.*' | grep '.*flow="rtmon-724a382d-84df-4cce-918a-3b68c75ba613".*' | grep '.*instance="T2_US_Caltech_Test:sandie-1.ultralight.org".*'; then
            echo 't2_us_caltech_test:sandie_1_ultralight_org_script_exporter_task1_rtmon_724a382d_84df_4cce_918a_3b68c75ba613{host="t2_us_caltech_test:sandie_1_ultralight_org"} 1' | curl --data-binary @- http://dev2.virnao.com:9091/metrics/job/single
        else
            echo 't2_us_caltech_test:sandie_1_ultralight_org_script_exporter_task1_rtmon_724a382d_84df_4cce_918a_3b68c75ba613{host="t2_us_caltech_test:sandie_1_ultralight_org"} 0' | curl --data-binary @- http://dev2.virnao.com:9091/metrics/job/single
        fi
        ...
        if curl http://dev2.virnao.com:9091/metrics | grep '.*arp_state.*' | grep '.*flow="rtmon-724a382d-84df-4cce-918a-3b68c75ba613".*' | grep '.*instance="T2_US_Caltech_Test:sandie-1.ultralight.org".*' | grep '.*IPaddress="10.251.87.162".*'; then
            echo 't2_us_caltech_test:sandie_1_ultralight_org_script_exporter_task2_rtmon_724a382d_84df_4cce_918a_3b68c75ba613{host="t2_us_caltech_test:sandie_1_ultralight_org"} 1' | curl --data-binary @- http://dev2.virnao.com:9091/metrics/job/single
        else
            echo 't2_us_caltech_test:sandie_1_ultralight_org_script_exporter_task2_rtmon_724a382d_84df_4cce_918a_3b68c75ba613{host="t2_us_caltech_test:sandie_1_ultralight_org"} 0' | curl --data-binary @- http://dev2.virnao.com:9091/metrics/job/single
        fi
        
        # check_arp_contain_ip
        if curl http://dev2.virnao.com:9091/metrics | grep '.*arp_state.*' | grep '.*flow="rtmon-724a382d-84df-4cce-918a-3b68c75ba613".*' | grep '.*instance="T2_US_SDSC:k8s-gen4-01.sdsc.optiputer.net".*' | grep '.*IPaddress="10.251.87.161".*'; then
