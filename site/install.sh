...
read -r -p "Install SNMP Exporter [y/N (Enter)]: " snmp_install
    ...
    wget -O /usr/share/snmp/mibs/F10-FIB-MIB http://www.circitor.fr/Mibs/Mib/F/F10-FIB-MIB.mib
    wget -O /usr/share/snmp/mibs/F10-FPSTATS-MIB https://www.circitor.fr/Mibs/Mib/F/F10-FPSTATS-MIB.mib
